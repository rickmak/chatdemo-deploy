...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.userConversationList = new _ManagedConversationList2.default();
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      this.userConversationList.subscribe(function () {
        _this2.forceUpdate();
    ...
    value: function updateUnreadCount() {
      ...
      var activeUC = this.userConversationList.get(activeID);
    ...
    value: function selectConversation(userConversation) {
      var unread_count = userConversation.unread_count;
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          userConversationList = this.userConversationList;

      var activeUC = userConversationList.get(activeID);
            ...
            case 'createGroup':
              return _react2.default.createElement(_CreateGroupModal2.default, {
                addConversationDelegate: function addConversationDelegate(c) {
                  return userConversationList.addConversation(c);
                },
            ...
            case 'details':
              return _react2.default.createElement(_DetailsModal2.default, {
                ...
                updateConversationDelegate: function updateConversationDelegate(c) {
                  return userConversationList.updateConversation(c);
                },
                removeConversationDelegate: function removeConversationDelegate(c) {
                  return userConversationList.removeConversation(c);
                },
                onClose: function onClose() {
                  return _this4.setState({ currentModal: null });
                } });
...
var _skygear = __webpack_require__(6);
  ...
  _createClass(Conversation, [{
    ...
    value: function fetchUsers() {
      ...
      Promise.all(participant_ids.map(function (userID) {
        ...
        var names = results.filter(function (u) {
          return u._id !== _skygear2.default.currentUser.id;
        }).map(function (u) {
    ...
    value: function sendMessage(messageBody) {
      if (messageBody.length > 0) {
        ...
        var message = new _skygear2.default.Record('message', {
          body: messageBody,
          metadata: {},
          conversation_id: new _skygear2.default.Reference(conversation.id),
          createdAt: new Date(),
          createdBy: _skygear2.default.currentUser.id
        });
        this.messageList.add(message);
        _skygear2.default.privateDB.save(message).then(function () {
          // force update the conversation on new message to trigger pubsub event
          _skygearChat2.default.updateConversation(conversation);
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          participant_count = _props.conversation.participant_count,
          _state = this.state,
          title = _state.title,
          users = _state.users,
...
var ConversationPreview = function (_React$Component) {
  ...
  _createClass(ConversationPreview, [{
    ...
    value: function render() {
      ...
      var unread_count = this.props.userConversation.unread_count;
      var _state = this.state,
          title = _state.title,
...
var CreateChatModal = function (_React$Component) {
  ...
  _createClass(CreateChatModal, [{
    ...
    value: function discoverUserAndCreateChat(username) {
      ...
      _skygear2.default.discoverUserByUsernames(username).then(function (users) {
        if (users.length <= 0) {
...
var DetailsModal = function (_React$Component) {
  ...
  _createClass(DetailsModal, [{
    ...
    value: function discoverAndAddUser(username) {
      ...
      this.setState({ loading: true });
      _skygear2.default.discoverUserByUsernames(username).then(function (_ref) {
        ...
        _react2.default.createElement(
          ...
          users.map(function (u) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement('div', {
                style: Object.assign({}, Styles.participantImage, { backgroundImage: 'url(' + (u.avatar ? u.avatar.url : 'img/avatar.svg') + ')' }) }),
              _react2.default.createElement(
                'span',
  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          style: Object.assign({}, Styles.container, { justifyContent: user._id === currentUserID ? 'flex-end' : 'flex-start' }) },
        _react2.default.createElement('div', {
          style: Object.assign({}, Styles.avatar, { backgroundImage: 'url(' + (user.avatar ? user.avatar.url : 'img/avatar.svg') + ')' }) }),
        _react2.default.createElement(
          'div',
          {
...
var SettingsModal = function (_React$Component) {
  ...
  _createClass(SettingsModal, [{
    ...
    value: function componentDidMount() {
      ...
      // fetch user profile
      _skygear2.default.publicDB.query(new _skygear2.default.Query(_skygear2.default.UserRecord).equalTo('_id', _skygear2.default.currentUser.id)).then(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 1),
            user = _ref2[0];
    ...
    value: function changeAvatar(imageFile) {
      ...
      _skygear2.default.publicDB.save(new _skygear2.default.UserRecord({
        _id: 'user/' + _skygear2.default.currentUser.id,
    ...
    value: function logout() {
      ...
      this.setState({ loading: true });
      _skygear2.default.logout().then(function () {
    ...
    value: function render() {
      ...
      var currentUsername = _skygear2.default.currentUser && _skygear2.default.currentUser.username;
...
var ManagedUserConversationList = function () {
  /**
   ...
   */
  function ManagedUserConversationList() {
    ...
    _classCallCheck(this, ManagedUserConversationList);
  ...
  _createClass(ManagedUserConversationList, [{
    key: 'destroy',
    ...
    key: '_userConversationsUpdated',
    value: function _userConversationsUpdated() {
      var _this = this;

      var _userConversations = this._userConversations,
          _compare = this._compare,
          _updateHandlers = this._updateHandlers;

      this._orderedIDs = Object.keys(_userConversations).map(function (id) {
        return _userConversations[id];
    ...
    value: function fetch() {
      ...
      return _skygearChat2.default.getUserConversations().then(function (results) {
        console.log('[fetched user conversations]', results);
        results.forEach(function (uc) {
          _this2._userConversations[uc._id] = uc;
          _this2._ucByCId[uc.$transient.conversation._id] = uc;
        });
        _this2._userConversationsUpdated();
        return _this2;
      });
    }
    /**
    ...
    value: function updateOne(conversation) {
      ...
      var _userConversations = this._userConversations,
          _ucByCId = this._ucByCId;

      _skygearChat2.default.getUserConversation(conversation).then(function (uc) {
        _userConversations[uc._id] = uc;
        _ucByCId[conversation._id] = uc;
        _this3._userConversationsUpdated();
      });
      return this;
    }
    /**
    ...
    value: function map(mappingFunction) {
      ...
      return this._orderedIDs.map(function (id) {
        return _this4._userConversations[id];
      }).map(mappingFunction);
    }
    /**
    ...
    value: function filter(predicate) {
      ...
      return this._orderedIDs.map(function (id) {
        return _this5._userConversations[id];
      }).filter(predicate);
    }
    /**
    ...
    value: function updateConversation(conversation) {
      ...
      if (_ucByCId.hasOwnProperty(conversation._id)) {
        ...
        var uc = _ucByCId[conversation._id];
        var c = uc.$transient.conversation;
    ...
    value: function removeConversation(conversation) {
      ...
      if (_ucById.hasOwnProperty(conversationID)) {
        var uc = _ucByCId[conversationID];
...
exports.default = ManagedUserConversationList;
...
var ManagedMessageList = function () {
  ...
  _createClass(ManagedMessageList, [{
    ...
    key: '_eventHandler',
    value: function _eventHandler(event) {
      if (event.record_type === 'message' && event.record.conversation_id.id === this._conversation.id) {
    ...
    value: function fetch() {
      ...
      return _skygearChat2.default.getMessages(this._conversation, resultLimit).then(function (results) {
        ...
        if (_this2._autoRead && results) {
          _skygearChat2.default.markAsLastMessageRead(_this2._conversation, results[0]);
        }
    ...
    value: function add(message) {
      ...
      if (!_messages.hasOwnProperty(message._id)) {
        ...
        if (this._autoRead) {
          _skygearChat2.default.markAsLastMessageRead(this._conversation, message);
        }
      }
      return this;
    }
...
var _container = __webpack_require__(99);
...
var v4 = __webpack_require__(266);
...
_skygear2.default.config(_config2.default.skygearConfig).then(function () {
  ...
  if (!_skygear2.default.currentUser) {
    window.location.href = 'login.html';
  } else {
...
var _pubsub = __webpack_require__(244);
...
var SkygearChatContainer = exports.SkygearChatContainer = function () {
  ...
  _createClass(SkygearChatContainer, [{
    ...
    value: function getConversations() {
      ...
      var query = new _skygear2.default.Query(Conversation);
      query.containsValue('participant_ids', _skygear2.default.currentUser.id);
