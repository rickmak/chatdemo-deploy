...
var _Authenticate = __webpack_require__(36);
...
_skygear2.default.config(_config2.default.skygearConfig).then(function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_Authenticate.Login, null), root);
});
...
var Login = exports.Login = function (_React$Component) {
  ...
  _createClass(Login, [{
    ...
    value: function login(username, password) {
      ...
      _skygear2.default.loginWithUsername(username, password).then(function () {
...
var Signup = exports.Signup = function (_React$Component2) {
  ...
  _createClass(Signup, [{
    ...
    value: function signup(username, password, passwordConfirm) {
      ...
      this.setState({ loading: true });
      _skygear2.default.signupWithUsername(username, password).then(function (user) {
